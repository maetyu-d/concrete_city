...
private:
    ...
    void renderFirstPersonScene(Vector2 playerTilePosition, int drawRadius, Vector2 viewForward = {0.0f, 0.0f}, bool cullToView = false);
    ...
    void startRainCrossfade(float duration);
    void finishRainCrossfade();
    ...
    Music m_rainMusicSecondary{};
    bool m_audioReady = false;
    bool m_rainPrimaryLoaded = false;
    bool m_rainSecondaryLoaded = false;
